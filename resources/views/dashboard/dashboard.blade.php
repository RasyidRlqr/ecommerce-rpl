...
<div class="container-fluid py-6 dashboard-page ">
 ...
 <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
  <div class="bg-white rounded-lg shadow-lg p-6 flex justify-between items-center hover:shadow-2xl transition-shadow duration-300">
    <div>
  ...
  <div class="bg-white rounded-lg shadow-lg p-6 flex justify-between items-center hover:shadow-2xl transition-shadow duration-300">
    <div>
      <p class="text-sm text-gray-500 uppercase tracking-wide">Completed Orders</p>
      <h2 class="text-2xl font-bold">{{ $pesananSelesai }}</h2>
    </div>
    <div class="bg-teal-100 text-teal-600 p-4 rounded-full text-2xl">
  ...
  <div class="bg-white rounded-lg shadow-lg p-6 flex justify-between items-center hover:shadow-2xl transition-shadow duration-300">
    ...
    <div class="bg-yellow-100 text-yellow-600 p-4 rounded-full text-2xl">
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
  ...
  <div class="bg-white rounded-lg shadow p-6">
    ...
    <canvas id="productsCategoryChart"
